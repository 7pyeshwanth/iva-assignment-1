# generate_scripts.py - Script to create required Python files and README
...
q2_code = """# q2.py - T-Pyramid Computation
import cv2
...
q4_code = """# q4.py - Edge Detection (Sobel & Canny)
import cv2
import numpy as np
...
q5_code = """# q5.py - Object Detection
import cv2
...
object_detection("images/input_image.png")
"""

def create_readme():
    readme_content = """# Image Processing Projects
...
# Create all scripts
create_script("q1.py", q1_code)
create_script("q2.py", q2_code)
create_script("q3.py", q3_code)
create_script("q4.py", q4_code)
create_script("q5.py", q5_code)
create_readme()

print("All script files and README.md have been generated successfully.")
